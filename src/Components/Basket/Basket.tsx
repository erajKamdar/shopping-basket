        ...
        <div className='basket'>
            <div className='text-center mt-5 '>
                {products.filter(product => product.added).length === 0 ? (
                    <>
                        <h1 style={{ color: "purple" }}>Basket</h1>
                        <span>Your Basket is Empty</span>
                        <br />
                        <Link to='/'><button className='btn btn-info mt-5'>Go buy stuff</button>
                        </Link>
                    </>)
                    :
                    ''
                ...
                <div >
                    ...
                    </table>
                    {
                        <div className="text-center col-sm-12 p-3">
                            <div className="card card-body payment">
